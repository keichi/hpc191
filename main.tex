...
AOBA-Sの外観写真を図\ref{fig:aoba-s}に示す．
AOBA-Sは表\ref{tbl:aoba-s}に示す通り，
...
アプリケーションの実行を担う．VEは2,048ビット幅のベクトル命令を備えるほか，HBMと密結合されており，
特にメモリ律速のアプリケーションにおいて高い性能を発揮するよう設計されている．
...
図\ref{fig:ve-card}にVector Engine Type 30A (VE30) プロセッサの外観を，
...
2\,MBのL3キャッシュが新設されている．L3キャッシュはソフトウェアによってバイパスすることが可能である．
...
これらの改良に加え，LLC内にリストベクトル演算を加速するためのハードウェア新設や，
単精度演算におけるアラインメント制約を緩和．
...
Largeスイートは約14.5\,TBのメモリを必要とし，大規模なクラスタを対象としている．
...
さらに性能評価および性能分析を進め，得られた知見を利用者に対して還元していく．
